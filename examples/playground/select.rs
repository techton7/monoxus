...
use monoxus::{
    ...
    select::{
        Select, SelectContent, SelectContentStatic, SelectGroup, SelectItem, SelectItemIndicator,
        SelectItemText, SelectLabel, SelectMode, SelectRoot, SelectSeparator, SelectTrigger, SelectValue, SelectViewport,
        use_select_runtime,
    },
};
...
// -------------------------------------------------------------------------
// Scenario 6: Multiple Selection with Repeated Hidden Inputs
// -------------------------------------------------------------------------

#[component]
fn MultipleSelectSection() -> Element {
...
// -------------------------------------------------------------------------
// Scenario 7: Static Non-Floating Content Lane
// -------------------------------------------------------------------------

#[component]
fn StaticContentSection() -> Element {

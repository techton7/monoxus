        ...
        div {
            ...
            div {
                ...
                SelectRoot {
                    ...
                    SelectContent {
                        style: "position: absolute; top: calc(100% + 4px); left: 0; width: 100%; z-index: 50; background: white; border: 1px solid #d8b4fe; border-radius: 0.375rem; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1); padding: 0.25rem; outline: none;",
                        SelectViewport {
                            SelectItem {
        ...
        div {
            ...
            div {
                ...
                SelectRoot {
                    ...
                    SelectContent {
                        style: "position: absolute; top: calc(100% + 4px); left: 0; width: 100%; z-index: 50; background: white; border: 1px solid #d8b4fe; border-radius: 0.375rem; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1); padding: 0.25rem; outline: none; max-height: 160px; overflow-y: auto;",
                        SelectViewport {
                            SelectItem {
...
fn ItemRow(text: &'static str, is_selected: bool) -> Element {
    rsx! {
        div {
            style: "display: flex; justify-content: space-between; align-items: center; padding: 0.375rem 0.5rem; border-radius: 0.25rem; font-size: 0.875rem; cursor: pointer; user-select: none;",
            SelectItemText {
                span { "{text}" }
            }
            SelectItemIndicator {
